...
INSERT INTO `contact` VALUES (1,'Henri','de Lauret',NULL,34,'Rue du Temple','henri@gmail.com',NULL,'0656784539',NULL,'BORDEAUX',33000,NULL,NULL,1,NULL),(2,'Elise','Lunet',NULL,106,'Cours Verdun','elise@gmail.com',NULL,'0563456785',NULL,'BORDEAUX',33300,'2° étage',NULL,NULL,1),(3,'Anna','Bonnet','LEADER PIECES AUTO',67,'Rue Gennet','anna@gmail.com',NULL,'0767867647','0567854368','LANGON',45000,NULL,1,NULL,NULL),(4,'Marie','Berthelot',NULL,45,'Rue André Gardon','anff@cpaonboard.com',NULL,NULL,'0675782736','BORDEAUX',33000,NULL,NULL,2,NULL),(5,'Myriam','Mitier',NULL,67,'Rue du Noyer','','m.mitter@gmail.com','0675376847',NULL,'Bordeaux',33400,'4e étage - Bat C',NULL,3,NULL);
...
INSERT INTO `contract` VALUES (1,'CDI','2020-12-03',NULL,NULL,NULL,NULL,1,NULL),(2,'CDD','2003-11-25',NULL,NULL,NULL,NULL,2,NULL),(3,'Stage','2011-02-25',NULL,NULL,NULL,NULL,3,NULL);
...
INSERT INTO `customer` VALUES (2,1),(1,2);
...
CREATE TABLE `employee` (
  ...
  `civility` enum('Mme','Mr','NC') CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  ...
  `department` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `employee` VALUES (1,'BDX33','M','Mr','1985-02-25','Paris',NULL,'SG',NULL,NULL,NULL,NULL,NULL,NULL,1),(2,'BDX34','F','Mme','2000-02-25','Agen',NULL,'ING',NULL,NULL,NULL,NULL,NULL,NULL,1),(3,'BDX35','F','Mme','1993-02-25','Guadeloupe',NULL,'CE',NULL,NULL,NULL,NULL,NULL,NULL,0);
...
INSERT INTO `litigation` VALUES (1,'2021-02-25 00:00:00','Souhaite un geste commercial',1,1),(2,'2021-12-03 00:00:00','Cloturé',2,2);
...
INSERT INTO `product_sale` VALUES (1,1,100,1,NULL,100,'2021-02-25 00:00:00');
...
INSERT INTO `sale` VALUES (1,'2021-02-25',100,50,50,1,'En cours',1,1),(2,'2021-02-26',50,NULL,NULL,0,'En attente',1,1);
...
CREATE TABLE `statusacquisition` (
  `id_statusAcquisition` int NOT NULL,
  `label` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,1,'BDX33','secret',1,NULL),(2,1,'BDX34','secret',2,NULL);
